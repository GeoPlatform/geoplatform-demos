...
#else
#    java $KC_OPTS -cp $DIRNAME/client/keycloak-admin-cli-13.0.0.jar org.keycloak.client.admin.cli.KcAdmMain "$@" --noconfig --token $(kcinit token admin-cli) --server $(kcinit show server)
#fi
